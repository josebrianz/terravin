            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ 'UGX ' . number_format($item->unit_price ?? $item['unit_price'] ?? 0, 0) }}</td>
                        <td>{{ $item->quantity ?? $item['quantity'] ?? 0 }}</td>
                        <td>{{ 'UGX ' . number_format($item->subtotal ?? (($item['quantity'] ?? 0) * ($item['unit_price'] ?? 0)), 0) }}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th>{{ 'UGX ' . number_format($order->total_amount, 0) }}</th>
                    </tr>
                </tfoot>
            </table>
        </div>
