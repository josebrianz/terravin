...
@section('title', 'Add New Wine Item - Terravin Wine')
        ...
        <div class="col-12">
            <div class="page-header border-bottom pb-3 mb-4 d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <span class="text-muted small">Add a new wine product to the inventory</span>
                </div>
            ...
            <div class="card wine-card shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0">
                    <h5 class="card-title mb-0 fw-bold text-burgundy">
                        <i class="fas fa-wine-bottle text-gold me-2"></i> Wine Item Details
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('inventory.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-burgundy">
                                <i class="fas fa-save"></i> Save Wine Item
                            </button>
                        </div>
                    </form>
                </div>
