...
<head>
    ...
    <title>Bulk Order History | TERRAVIN</title>
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="history-section">
                <h2 class="section-title mb-3"><i class="fas fa-history text-gold me-2"></i>Bulk Order History</h2>
                @if($orders->count())
                    ...
                    <table class="table table-bordered order-table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge fw-bold" style="font-size:1rem; background: #b85c00; color: #fff;">
                                        {{ ucfirst(trim($order->status, "' ")) ?: 'Pending' }}
                                    </span>
                                </td>
                                <td><span class="text-gold fw-bold">${{ number_format($order->total_amount, 2) }}</span></td>
                                <td>
                                    <a href="{{ route('vendor.bulk-order.confirmation', $order->id) }}" class="btn btn-outline-burgundy btn-sm">View</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                @else
                <div class="alert alert-info">No bulk orders found.</div>
                @endif
                <a href="{{ route('vendor.bulk-order.form') }}" class="btn btn-burgundy mt-3">
                    <i class="fas fa-plus me-2"></i>Place New Bulk Order
                </a>
