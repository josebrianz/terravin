...
<div class="contracts-theme-bg min-vh-100 py-5">
    <div class="container">
        <div class="contracts-card">
            <div class="contracts-title">
                <i class="fas fa-file-contract text-gold"></i> Vendor Contracts
            </div>
            <div class="alert alert-info mb-4">No contracts yet. This page will show your vendor agreements and contracts.</div>
